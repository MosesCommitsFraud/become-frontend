...
const packages = [
    {
        name: 'BASIC',
        subtitle: 'become situation-aware',
        ...
        footer: 'providing insights on your situation',
        contactText: 'Contact Sales',
    },
    {
        name: 'PREMIUM',
        subtitle: 'become strategy-focused',
        description: 'All BASIC services as well as',
        services: [
            'eCommerce Platform Assessment',
            'Online Branding Strategy Workshop',
            'Online Sales Strategy Workshop',
        ],
        footer: 'showing up your options',
        contactText: 'Contact Sales',
        highlighted: true,
    },
    {
        name: 'ULTIMATE',
        subtitle: 'become online-present',
        description: 'All BASIC and PREMIUM services as well as',
        services: [
            'Online Brand ImageCreation',
            'eCommerce Platform Implementation',
            'Custom Sales Strategy Development',
        ],
        footer: 'realizing your eCommerce presence',
        contactText: 'Contact Sales',
    },
]
