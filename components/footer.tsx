...
export default function Footer() {
    return (
        <footer
            className="z-10 fixed bottom-5 left-0 right-0 w-10/12 mx-auto bg-[#262626] bg-opacity-80 backdrop-blur-sm text-white p-2 flex justify-between items-center rounded-xl shadow-lg">
